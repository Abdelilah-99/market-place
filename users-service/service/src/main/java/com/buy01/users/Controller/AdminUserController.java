...
public class AdminUserController {
    ...
    public ResponseEntity<RegisterResDTOs> reindexUserSearch() {
        long indexed = adminUserService.reindexUserSearch();
        return ResponseEntity.ok(new RegisterResDTOs("indexed " + indexed + " users"));
    }
