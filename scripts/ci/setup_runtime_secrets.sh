...
mkdir -p gateway/certs products-service/certs media-service/certs payments-service/certs users-service/certs
...
for service_cert_dir in gateway/certs products-service/certs media-service/certs payments-service/certs users-service/certs; do
